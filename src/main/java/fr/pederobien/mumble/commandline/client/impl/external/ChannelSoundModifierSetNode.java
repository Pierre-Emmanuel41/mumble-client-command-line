...
public class ChannelSoundModifierSetNode extends MumbleClientNode<IExternalMumbleServer> {
	 ...
	 */
	protected ChannelSoundModifierSetNode(Supplier<IExternalMumbleServer> server) {
