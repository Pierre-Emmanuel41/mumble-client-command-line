...
public class ChannelAddChannelNode extends MumbleClientNode<IExternalMumbleServer> {
	 ...
	 */
	protected ChannelAddChannelNode(Supplier<IExternalMumbleServer> server) {
