...
public class ChannelSoundModifierDetailsNode extends MumbleClientNode<IExternalMumbleServer> {
	 ...
	 */
	protected ChannelSoundModifierDetailsNode(Supplier<IExternalMumbleServer> server) {
